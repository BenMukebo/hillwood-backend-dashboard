...
ActiveRecord::Schema[7.0].define(version: 2024_01_05_142923) do
  ...
  create_table "series", force: :cascade do |t|
    ...
    t.integer "category"
    t.string "image_url"
    t.jsonb "content_details"
    t.integer "status"
    t.bigint "movie_genre_id", null: false
    t.bigint "video_id", null: false
    t.bigint "movie_writter_id", null: false
    t.bigint "movie_outcast_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["content_details"], name: "index_series_on_content_details"
    ...
    t.index ["video_id"], name: "index_series_on_video_id"
  end
