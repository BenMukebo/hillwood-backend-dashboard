  ...
  test 'should create movie_writter' do
    assert_difference('MovieWritter.count') do
      post movie_writters_url,
           params: { movie_writter: { avatar_url: @movie_writter.avatar_url, first_name: @movie_writter.first_name, last_name: @movie_writter.last_name, personal_details: @movie_writter.personal_details, status: @movie_writter.status } }, as: :json
    end
